...
<head>
<title>Sparkbrowser - Media</title>
...
<link rel="stylesheet" media="all" href="http://sparkbrowser.com/assets/A.jquery-jvectormap.css.pagespeed.cf.tT-tipostt.css"/>
<script src="http://sparkbrowser.com/assets/jquery-jvectormap.js.pagespeed.jm.XZY9CV1zG1.js"></script>
<script src="http://sparkbrowser.com/assets/jquery-jvectormap-world-en.js.pagespeed.jm.DNmW0w58Un.js"></script>
<script>var gdpData={"US":25071,"CN":3522};$(function(){$('#map').vectorMap({map:'world_en',values:gdpData,scaleColors:['#DCDCDC','#008000'],normalizeFunction:'polynomial',hoverOpacity:0.7,hoverColor:false,onLabelShow:function(e,el,code){el.html(el.html()+' (sales: '+gdpData[code]+')');}});})</script>
<script type="text/javascript" src="https://www.google.com/jsapi"></script>
<script type="text/javascript">google.load("visualization","1",{packages:["corechart"]});google.setOnLoadCallback(drawChart);function drawChart(){var data=google.visualization.arrayToDataTable([['Browser','Revenue Growth'],['Sparkbrowser',45.11],['Chrome',4.71],['Firefox',3.33],['IE',2.80],['Safari',2.30]]);var options={title:'Aggregate Monthly Revenue Growth'};var chart=new google.visualization.PieChart(document.getElementById('chart_div'));chart.draw(data,options);}</script>
<script type="text/javascript">google.load("visualization","1",{packages:["corechart"]});google.setOnLoadCallback(drawChart);function drawChart(){var data=google.visualization.arrayToDataTable([['Browser','Latency'],['Sparkbrowser',0.11],['Chrome',0.23],['Firefox',0.33],['IE',0.80],['Safari',2.30]]);var options={title:'Relative Latency *SP-108'};var chart=new google.visualization.PieChart(document.getElementById('chart_div1'));chart.draw(data,options);}</script>
<head>
<script type="text/javascript">google.load("visualization","1",{packages:["corechart"]});google.setOnLoadCallback(drawChart);function drawChart(){var data=google.visualization.arrayToDataTable([['Year','Sales','Expenses'],['2004',1000,400],['2005',1170,460],['2006',660,1120],['2007',1030,540]]);var options={title:'Company Performance'};var chart=new google.visualization.LineChart(document.getElementById('chart_div3'));chart.draw(data,options);}</script>
<body class="">
...
<li class=" active"><a href="media.php"><span>Media</span></a></li>
...
<div class="article">
<div class="headline">
<h1 class="article-title">Sparkbrowser Analytics</h1>
<div class="clear"></div>
</div>
<hr>
<div>
<h2>Sparkbrowser is a fully featured web browser, with support for Javascript, HTML5, CSS3, Web GL, and more modern languages and web frameworks. Our browser is outstanding, and will never crash. Some browsers work to lead content all at once, and are latent after loading a page. Sparkbrowser stays working and distributes the work over a longer period of time. This method of loading takes less time, because when the user is reading the web page, the next pages are beginning to load in cache memory. The user can watcht he dynamic page map grow, and view the content that is already available, and make a decision based on which content has been loaded so far.</h2>
<hr>
<p>Sparkbrowser analytics provides us with real time usage statistics, none of your personal data is every transmitted, and this does not affect latency in any way. The browser waits for a good time to send us usage statistics that will not affect performance. It will not try to send statistics while you are downloading a file or using data transfer. The statistics is a simple JSON file with data bout apps, and the amount of times apps were used. we have examples of these JSON files available to see what kind of data is collected, but we randomize the data so that it will never correspond to your sparkbrowser account. These data files allow us to see which countries our browser is most popular, and what kind of apps these users like.</p>
<p>we show you the same statistics we use in our enterprise system on your control panel. This lets you see how the browser is growing, and allows you to watch in real time as the browser gains marketshare. We think it is important to have good statistics for our browser, and a scalable system for rewarding users who use the browser.</p>
<p>THe sparkbrowser ETF program is in effect, and more data will be published about this program in the future. </p>
<p>This strategy involves weaving a product model and a hedge fund in to one entity, mutually profiting from one another and further lowering the risk of starting a company.</p>
<p>Sparkbrowser is 100% sustainable, whether we get 1 download or 1 billion, there is profit margin with every single download</p>
</div>
</div>
</div>
</div>
...
<div id="chart_div1" style="width: 300px; height: 300px;"></div>
</div><!-- END SIDEBAR B -->
</div><!-- END GRID 3 -->
<div class="clear"></div>
</div>
