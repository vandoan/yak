...
<div class="article">
<div class="headline">
<h1 class="article-title"> Quad View</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
...
<br/><br/>
<br/>
<img src="images/n11.png" width="700"/>
<p>Quad view is a feature that appeals to users with big monitors. Have you ever used an external monitor or projector and found it pointless to use such a large screen when the site centers in the window and only uses half of the space? With quad view you can view up to four websites at once and browse between them with ease. The quad view is a seperate entity from the tabs, but elements can be moved by dragging them in to the quad view panel.</p>
<p>Quad view has never been used in browsers before and Sparkbrowser and Spark Software Group are leading the way in UI design in the browser market.</p>
<p>Sparkbrowser is the only premium low latency browser on the market, there are no competitors because free browsers do not value the user expereince above all else, and often cut costs to keep costs low.</p>
</div>
</div>
</div>
</div>
