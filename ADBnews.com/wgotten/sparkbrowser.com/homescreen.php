...
<div class="article">
<div class="headline">
<h1 class="article-title">Homescreen</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
...
<h3>Sparkbrowser has a new and innovative homescreen that is the focal point of our new design. Our browser allows people to share their homescreen with other members even if they do not use sparkbrowser. The homescreen is a desktop for the web, a secondary operating system that seamlessly integrates online and offline content.</h3>
<p>The majority of internet users only visit a very small subset of the websites on the internet, in most cases less than 100 websites are visited on a daily basis.</p>
<p>Why spend time searching for the same sites in google many times, searching for sites wastest time. Keep all of your favorit websites in one place. Google chrome can store about 12 </p>
</div>
</div>
</div>
</div>
