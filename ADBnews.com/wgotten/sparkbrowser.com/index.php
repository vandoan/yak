...
<head>
<title>Sparkbrowser-Official Site</title>
<meta name="robots" content="index, follow"/>
<meta name="keywords" content="Sparkbrowser, Web Browser, browser, Chrome, Website, Best Web Browser, Fastest Web Browser, Safari"/>
<meta name="description" content="Sparkbrowser is the fastest web browser in the world"/>
...
<style>#mask{position:absolute;z-index:9000;background-color:#000;display:none}#close_button{padding-top:425px}#boxes .window{position:fixed;width:440px;height:200px;display:none;z-index:9999;padding-top:20px;padding-bottom:10px;padding-right:10px;background-image:url(http://sparkbrowser.com/images/xsb_notice.png.pagespeed.ic.eqL_FN3CLu.png)}#boxes #dialog{width:750px;height:460px}</style>
<style>#css-image-swap-2{width:135px;height:35px;background:url(data:image/png;base64,)}#css-image-swap-2:hover{opacity:.7}</style>
...
<script>function function_onload()
{var id="#dialog";var maskHeight=$(document).height();var maskWidth=$(window).width();$('#mask').css({'width':maskWidth,'height':maskHeight});$('#mask').fadeIn(1000);$('#mask').fadeTo("slow",0.8);var winH=$(window).height();var winW=$(window).width();$(id).css('top',winH/2-$(id).height()/2);$(id).css('left',winW/2-$(id).width()/2);$(id).fadeIn(2000);$('.window .close').click(function(e){e.preventDefault();$('#mask, .window').hide();});$('#mask').click(function(){$(this).hide();$('.window').hide();});}</script>
...
<a href="#" class="close learn-more" title="continue">
Continue
</a>
</div>
</div>
...
<body class="homepage" onload="function_onload()">
...
<li class="index.php"><a href="appstore.php"><span>App Store</span></a></li>
</ul>
</li>
...
<div class="sliderbutton prev" onclick="slideshow.move(-1)"></div>
<div id="slider">
<ul>
<li><a target="_self" href="#"><img alt="Slide 3" src="http://sparkbrowser.com/images/slides/xslide4245.png.pagespeed.ic.bFe92R6e16.png"/></a></li>
<li><a target="_self" href="#"><img alt="Slide 1" src="http://sparkbrowser.com/images/slides/xsparkslide1.png.pagespeed.ic.gOOPi4pzqF.png"/></a></li>
<li><a target="_self" href="#"><img alt="Slide 4" src="http://sparkbrowser.com/images/slides/xslide1123.png.pagespeed.ic.Nn41TUtZfQ.png"/></a></li>
<li><a target="_self" href="#"><img alt="Slide 2" src="http://sparkbrowser.com/images/slides/xslide2345.png.pagespeed.ic.XWL_hRAm_2.png"/></a></li>
</ul>
</div><!-- End SLIDES -->
<div class="sliderbutton next" onclick="slideshow.move(1)"></div>
...
</div><!-- End SHOWCASE POSITION -->
<div id="feature">
<div class="abr-container ">
<div class="grid_9">
<div class="homeTitle">
<div class="abr-block">Sparkbrowser is the newest and best web browser, loading pages faster than all current browsers, and organizing content in the most customizeable way possible. </div>
<hr>
</div>
</div>
<div class="grid_3">
<div class="findOut">
<div class="abr-block"><a href="features.php" title="Find out more">find out more</a></div>
</div>
</div>
</div>
</div><!-- End FEATURE -->
...
<div class="article">
<div class="headline">
<h1 class="article-title">Welcome to Sparkbrowser</h1>
<div class="clear"></div>
</div>
<h2>Sparkbrowser is an innovative HTML5 web browser built in Cambrige MA. Our software organizes offline and online content in a new format, an operating system for the web.</h2>
<p>Our company was founded in 2010 to gain marketshare. when only 5 companies control the entire browser market, there is little competiton, and limitless possiblilty in the untapped browser market</p>
<p>Sparkbrowser is a premium web browser, the first of its kind to offer premium services for customers. When the browser is the second most used application on the computer, only after the operating system, it makes sense to own a premium browser.</p>
<p>Being a premium browser users will enjoy exclusive benefits like cloud storage for files, music streaming, and subscriptions to premium news outlets. These services come standard with Sparkbrowser. </p>
<p>Being a premium browser we <b>never sell your information</b> and all of your local data is encrypted.</p>
<p>Sparkbrowser is an innovative new product, combining premium services to traditionally open-source products. allowing users to organize online content in the same way as offline content. For Example saving website articles as an icon on their home-screen.</p>
</div>
</div>
...
<li id="tech-html5"><a href="html5.php"><span class="feature-link-content">HTML5<span>Layout</span></span></a></li>
<li id="tech-css"><a href="css.php"><span class="feature-link-content">Modern <span>CSS</span></span></a></li>
<li id="tech-apis"><a href="api.php"><span class="feature-link-content">Strong<span>APIs</span></span></a></li>
<li id="tech-tools"><a href="support.php"><span class="feature-link-content">Customer<span>Support</span></span></a></li>
<li id="tech-svg"><a href="layout.php"><span class="feature-link-content">Perfect<span>Layout</span></span></a></li>
</ul>
</div>
...
<h2 class="title">Download Our Browser September 2013 </h2>
</div>
...
<li><a href="appstore/index.html"><span>App Store</span></a></li>
...
<div class="abr-block">
<div class="module-title">
<h2 class="title">Efficient Layout</h2>
</div>
<h6>Save time and money, be more efficient while working, and organize sites by type. or even open a new Spark&trade; for work.</h6>
<p>Sparkbrowser organizes websites like icons on a desktop. This user interface seamlessly integrates offline and online content, and serves as a desktop for the web. Complete with a background, user accounts, notifications, and browser compatible software applications.</p>
<p><a class="learn-more" href="efficientlayout.php">Learn more</a></p>
</div>
</div>
</div>
<div class="grid_4">
<div class="abr-block">
<div class="module-title">
<h2 class="title">Affiliate Network</h2>
</div>
<p><img width="280" height="108" class="with-shadow" alt="Let's do business!" src="http://sparkbrowser.com/images/content/280x108xhandshake.jpg.pagespeed.ic.b2rYxExGGY.jpg"/></p>
<p>We are always looking for affiliate referrals! Join our affiliate network and recieve an 80% payout!</p>
</br>
<p><a class="learn-more" href="affiliatenetwork.php">Learn more</a></p>
</div>
</div>
<div class="grid_4">
<div class="modRight">
...
<h6>Interested in adding an application to our app store? Submit your app for review, and see it on our store in only 2 weeks!</h6>
<p>All apps must be free, browser compatible, and within our app compliance guidelines.</p>
<p>Our App Store features different apps, and entire Sparks&trade; that can be downloaded and used on any verified copy of Sparkbrowser &trade;</p>
<p><a class="learn-more" href="appstore.php">Learn more</a></p>
</div>
</div>
</div>
</div>
...
<ul>
<li>
<h4><a href="#">Sparkbrowser Featured on Boston.com and CBS</a></h4>
...
<li>
<h4><a href="#">App Store to have 10,000 apps by spring</a></h4>
<p>The Sparkbrowser App Store, to compete with Google, Apple, and Mozilla, our app store features streamlined apps, and themes that can be downloaded with the click of a mouse, credit card not required.</p></li>
<li>
<h4><a href="#">Sparkbrowser LE</a></h4>
<p>Sparkbrowser Limited Edition &trade; is only available to the first 10,000 members to download the browser. This edition features a multitude of free services, and a portion of the app store only available to Limited Edition clients.</p></li>
<li>
<h4><a href="#">Share Your Spark &trade;</a></h4>
...
<p>Our privately held company is based in Cambridge MA, the technology capital of the world. Our brand has a history of excellence, and our product is the first of its kind. Our competitors are Apple, Google, Microsoft, and Mozilla. Welcome to Sparkbrowser&trade;</a></p>
...
<li><p>Sparkbrowser is the most anticipated browser, with great reception in southeast asian markets, Sparkbrowser will also appeal to american markets with premium services and modern style. With Google, Apple, Microsoft and Mozilla as competition, gaining marketshare is a great challenge. But to us challenge is an open invitation. </p>
</ul>
</div>
</div>
</div>
...
<li><a href="companyoverview.pdf"><span>Company Overview</span></a></li>
</ul>
</div>
</div><!-- end footer menu -->
</div>
...
<p><!-- phone number  --><br/><a href="#">info@sparkbrowser.com</a></p>
</div>
</div>
<div class="grid_2">
...
<script type="text/javascript">var slideshow=new TINY.slider.slide('slideshow',{id:'slider',auto:3,resume:true,vertical:true,navid:'pagination',activeclass:'current',position:0});var latestPosts=new TINY.slider.slide('latestPosts',{id:'posts',auto:3,resume:true,vertical:false,navid:'LP-pagination',activeclass:'current',position:0});var testimonials=new TINY.slider.slide('testimonials',{id:'testimonials',auto:2,resume:true,vertical:false,navid:'',activeclass:'current',position:0});jQuery(function($){var pagination1=$("#pagination");var count=$("#pagination li").length*16/2;pagination1.css("margin-left","-"+count+"px");});</script>
</body>
</html> 