...
<head>
<title>Sparkbrowser Official Site - Contant</title>
...
<li class="last-child active "><a href="contact.php"><span>Contact</span></a></li>
</ul><!-- End MAIN MENU -->
...
<h3>We just updated our site, so if you see an error PLEASE let us know! Thanks</h3>
<div class="rapid_contact">
<form method="post" action="contact_formula.php" name="contact"/>
<table>
<tbody>
<tr>
<td>Name:</td>
<td><input type="text" value="" size="25" name="name" class="rapid_contact inputbox "/></td>
</tr>
<tr>
<td>Email:</td>
<td><input type="text" value="" size="25" name="email" class="rapid_contact inputbox "/></td>
</tr>
<tr>
<td>Subject:</td>
<td><input type="text" value="" size="25" name="subject" class="rapid_contact inputbox "/></td>
</tr>
<tr>
<td valign="top">Message:</td>
<td><textarea rows="4" cols="30" name="message" class="rapid_contact textarea "></textarea></td>
</tr>
<tr>
<td colspan="2"><input type="submit" style="width: 20%;" value="Send Message" class="rapid_contact button "/></td>
</tr>
</tbody>
</table>
</form>
...
<p>Spark Software Group<br/>Cambridge MA<br/>Broadway<br/>United States&nbsp;</p>
</div>
</div><!-- END SIDEBAR B -->
</div><!-- END GRID 3 -->
<div class="grid_3">
...
<p><a href="http://facebook.com/sparkbrowser">Facebook.com/sparkbrowser</a><br/><a href="http://twitter.com/sparkbrowser">Twitter.com/sparkbrowser</a></p>
</div>
<div class="rt-block">
<div class="module-title">
<h2 class="title">Email</h2>
</div>
<p>www.sparkbrowser.com</p>
<p>info@sparkbrowser.com<br/>sales@sparkbrowser.com</p>
</div>
</div><!-- END SIDEBAR B -->
</div><!-- END GRID 3 -->
<div class="clear"></div>
