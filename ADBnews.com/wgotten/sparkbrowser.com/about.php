...
<head>
<title>Sparkbrowser official Site - About</title>
...
<meta name="keywords" content="Sparkbrowser, Web Browser, software, fastest web browser "/>
...
<link rel="stylesheet" media="screen" href="http://sparkbrowser.com/css/A.superfish.css+technology.css,Mcc.r9V97luBWf.css.pagespeed.cf.HEV7TFwyAS.css" type="text/css"/>
...
<a id="logo" href="http://myfile.ro/abrax/"></a>
...
<a target="_blank" href="http://www.linkedin.com/company/sparkbrowser" rel="nofollow"><img title="Follow us on Linkedin" alt="Linkedin" src="data:image/png;base64,"/></a>
<div class="clear"></div>
</div>
...
<ul class="sf-menu">
<li class="first-child" id="current"><a href="index.php"><span>Home</span></a></li>
<li class=""><a href="download.php"><span>Download</span></a></li>
<li class=" active parent"><a href="about.php"><span>About</span></a>
<ul>
...
<div class="abr-block">
<h2 style="text-align: center;">The Fastest Web Browser - Coming September 2013</h2>
</div>
</div>
</div>
<div class="clear"></div>
...
<div class="clear"></div>
</div><!-- End SHOWCASE POSITION --> <script type="text/javascript" src="http://www.google.com/jsapi"></script>
<script type="text/javascript">google.load('visualization','1',{packages:['corechart']});</script>
<script type="text/javascript">function drawVisualization(){var data=google.visualization.arrayToDataTable([['Browser','Sparkbrowser','Chrome','Firefox','Internet Explorer','Safari','Sector'],['Advertising',500,938,522,998,450,614.6],['Data Collection (ms)',1120,112,599,1268,288,682],['Speed (ms)',1167,670,587,807,397,623],['Apps',1390,1010,615,968,215,609.4],['Profit Potential',1300,640,330,404,404,416]]);var ac=new google.visualization.ComboChart(document.getElementById('visualization'));ac.draw(data,{title:'Profit Potential By Sector',width:600,height:400,vAxis:{title:"Browser"},hAxis:{title:"Sector"},seriesType:"bars",series:{5:{type:"line"}}});}
google.setOnLoadCallback(drawVisualization);</script>
<script type="text/javascript" src="http://www.google.com/jsapi"></script>
<script type="text/javascript">google.load('visualization','1',{packages:['corechart']});</script>
<script type="text/javascript">function drawVisualization(){var data=google.visualization.arrayToDataTable([['Task','Rendering Time'],['Text',11],['Images',28],['Streaming',2],['operations',6],['Memory allocation',7]]);new google.visualization.PieChart(document.getElementById('visualization1')).draw(data,{title:"Browser Tasks Relative Speed (ms)"});}
google.setOnLoadCallback(drawVisualization);</script>
<script type="text/javascript">google.load('visualization','1',{packages:['corechart']});</script>
<script type="text/javascript">function drawVisualization(){var data=google.visualization.arrayToDataTable([['resource','scalable MB'],['Cached Pages',20],['Text Recognition',5],['default Styles',2],['Browsing Map',2],['Settings',7]]);new google.visualization.PieChart(document.getElementById('visualization2')).draw(data,{title:"Memory Allocation (MB)"});}
google.setOnLoadCallback(drawVisualization);</script>
<script type="text/javascript">google.load('visualization','1',{packages:['corechart']});</script>
<script type="text/javascript">function drawVisualization(){var data=google.visualization.arrayToDataTable([['Browser','Text','Images','Streaming','operations','Latency','Sector'],['Sparkbrowser',145,930,365,998,96,614.6],['Chrome',135,1000,599,866,288,682],['Firefox',157,830,587,973,397,623],['IE',196,1110,615,968,215,609.4],['Safari',148,1200,629,1026,366,569.6]]);var ac=new google.visualization.ComboChart(document.getElementById('visualization3'));ac.draw(data,{title:'Rendering Speed by type',width:350,height:300,vAxis:{title:"Latency"},hAxis:{title:"Browser"},seriesType:"bars",series:{5:{type:"line"}}});}
google.setOnLoadCallback(drawVisualization);</script>
<script type="text/javascript">google.load('visualization','1',{packages:['corechart']});</script>
<script type="text/javascript">function drawVisualization(){var data=google.visualization.arrayToDataTable([['Browser','HTML','PDF','CSV','Video','MP3','Average'],['Sparkbrowser',106,938,522,700,110,614.6],['Chrome',135,1120,599,1268,288,682],['Firefox',157,1167,587,807,397,623],['IE',139,1110,615,968,215,609.4],['Safari',136,691,629,1026,366,569.6]]);var ac=new google.visualization.ComboChart(document.getElementById('visualization4'));ac.draw(data,{title:'Startup Time',width:350,height:300,vAxis:{title:"% MS"},hAxis:{title:"Browser"},seriesType:"bars",series:{5:{type:"line"}}});}
google.setOnLoadCallback(drawVisualization);</script>
<!-- End BREADCRUMBS -->
<div id="main">
<div class="abr-container ">
...
<div id="content-top">
<br/>
<div align="center"><img src=" images/slides/sparkslide2.png" width="700"></img></div>
<div class="grid_3 abr-alpha">
<div class="abr-block">
<div class="module-title">
<h2 class="title">Speed</h2>
</div>
<p>Our browser is the fastest browser available on the market, and performs better than chrome in benchmarking tests.</p>
</div>
</div><!-- end grid 3 -->
<div class="grid_3">
<div class="abr-block">
...
<p>Our browser ensures that all malicious code is blocked and security threats are minimized. </p>
</div>
</div><!-- end grid 3 -->
<div class="grid_3 abr-omega">
<div class="abr-block">
<div class="module-title">
<h2 class="title">Support</h2>
</div>
<p>Our premium browser provides customer support, and many services that limited open source browsers can not.</p>
</div>
</div><!-- end grid 3 -->
</div><!-- end content top -->
...
<div class="article">
<div class="headline">
<h1 class="article-title">About Our Company</h1>
<div class="clear"></div>
</div>
<p>Founded in 2010 to solve the problems with traditional web browsers, our team wen to work to build the best browser available on the market. We took exisiting features that we liked from exisiting browsers, made them better, and got rid of the features that we did not like. Eventually we built a better product than apple, mozilla, google, and microsoft, combined. </p>
<p>Our browser was faster, more stable, and more secure than leading browsers, and needed to gain marketshare. two weeks folling our first release the browser had been downloaded over 25,000 times, mostly in asian markets. This browser was to test concepts that we had been developing liek the autosearch API, similar to the google combined URL and search bar. </p>
<h3>Sparkbrowser project 2011</h3>
<p>Starting in 2011 data had been collected form our first test project. this data allowed us to engineer new features and leave out features that were seldom used by customers. Additionally our next browser had to be cross platofrm to reach the entire market. In recent years there has been a shift to the MAC platform, and to the popular Safari browser produced by the apple corporation. Our switch to the MAC platofrm will give a larger marketshare across the entire market, and ability to provide additional software for the MAC platform. </p>
<p>Our browser is produced on limited funding, and has secured $25,000 seed investment from venture capital. In the future our browser will be fully sustainable on a budget of less than 6 million dollars per year, a fraction of the cost that traditional browsers operate on. </p>
<p>In late 2011 our offices have moved to Cambridge MA, the technology capital of the world, home to biotechnology firms, countless internet companies, and thwo leading research universities. </p>
</div>
</div>
</div>
<div class="grid_3">
...
<div class="abr-block">
<div class="module-title">
<h2 class="title">Download Our Browser Fall 2012</h2>
</div>
...
<div id="visualization1" style="width: 350px; height: 300px;"></div>
<div id="visualization2" style="width: 350px; height: 300px;"></div>
<div id="visualization3" style="width: 300px; height: 300px;"></div>
<div id="visualization4" style="width: 300px; height: 300px;"></div>
</div><!-- END SIDEBAR B -->
</div><!-- END GRID 3 -->
<div class="clear"></div>
</div>
