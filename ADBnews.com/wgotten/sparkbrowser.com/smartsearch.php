...
<div class="article">
<div class="headline">
<h1 class="article-title">Smart Search (F10)</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
...
<br/><br/>
<br/>
<img src="images/searchterm.png" width="700"/>
<p>Sparkbrowser smart search uses the Google API and Bing API to create an average index based on previous searches and the likelihood that a page will be clicked on.
Additionally our Smart Search will recognize URL's and even scrape pictures from a site or certain files depending on the search term.
For example you search for "NASDAQ PDF" the search will only return PDF's and previews of PDF's that are likely to contain nasdaq information.
Our custom search is a an analysis engine that uses data from major search engines, using our proprietary ranking algorithms.</p>
</div>
</div>
</div>
</div>
