...
<div class="article">
<div class="headline">
<h1 class="article-title">Bookmarks Bar (CTRL-B)</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
...
<br/><br/>
<br/>
<img src="http://sparkbrowser.com/images/700xNxbmb2.png.pagespeed.ic.Ppw2rr2Cx3.png" width="700"/>
<h3>Sparkbrowser has a retractable bookmarks bar</h3>
<p>Our bookmarks bar is essentially the same as all other browsers bookmarks bar, It is a legacy feature that will be phased out in the future and the drop dwn dock will be able to dynamiclly create foldes on the Sparkbrowser desktop, icons, and apps.</p>
<p>If you have the BETA version for 2013 you will not have the Bookmarks Bar included in your browser.</p>
<p>Bookmarks are essentially text icons. The human brain processes images faster than text, that is why it is easier to watch tv or a movie than read a book. This being known, icons are much faster than text links.</p>
<p>In the event that there is no icon, Sparkbrowser will create one.</p>
<p>In the event that the file is not a web page, and is a video clip or text document, Sparkbrowser will create an icon that it thinks best represents the data. A video thumbnail or picture of the main theme of a PDF will suffice as an icon.</p>
<p>For example a PDF containing trading rules for NASDAQ might determine NASDAQ to be the thme of the file, and also append the PDF Logo to the file in a small image bubble</p>
<p>Sparkbrowser is unlimited innovation, buy our software and outperform the competition</p>
</div>
</div>
</div>
</div>
