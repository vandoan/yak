...
<head>
<title>Sparkbrowser Official Site - Spark</title>
...
<li class="parent active"><a href="about.php"><span>About</span></a>
<ul>
...
<div class="abr-block">
<h2 style="text-align: center;">The Fastest Web Browser - Coming Summer 2012</h2>
</div>
</div>
</div>
<div class="clear"></div>
...
<div class="article">
<div class="headline">
<h1 class="article-title">Sparkbrowser Features</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
<ul class="feature-links">
<li id="tech-html5"><a href="html5.php"><span class="feature-link-content">Innovating <span>With HTML5</span></span></a></li>
<li id="tech-css"><a href="css.php"><span class="feature-link-content">Beautifying <span>With CSS</span></span></a></li>
...
<li id="tech-svg"><a href="layout.php"><span class="feature-link-content">Creative<span>Layout</span></span></a></li>
</ul>
</div> <div>
<br/>
<br/><br/>
...
<br/><br/>
<br/>
<img src="images/homescreen.png" width="700"/>
<p>Sparkbrowser is the latest web browser on the market for 2013 and although it is premium, it comes with some amazing features you can share with anyone. Spark is our proprietary layout engine for websites that you can create, and sharew with your friends to use. </p>
<p>Make Sparks and sell them to your friends, show them to your friends and family, create a website with them, or share them on facebook adn twitter to amaze your friends.</p>
<p>Your friends will not be able to edit the spark because only users who have sparkbrowser can edit a spark.</p>
<p>If you are freinds withanother sparkbrowser user you can share sparks wioth each other and edit them how you please</p>
<p>All sparkbrowser users can uplaod thei spark to the spark gallery on our website for other users to download</p>
<p>Don't want to add every news site to your spark yourself? To reduce the time it would take you to make one from scratch, search 'news' in sparkbrowser spark gallery and download a news spark preloaded with all of the news sites</p>
<p>Sparks that are visited by non sparkbrowser users show the sparkbrowser branding and logos</p>
</div>
</div>
</div>
</div>
...
<h2 class="title">Download Our Browser Spring 2013</h2>
</div>
