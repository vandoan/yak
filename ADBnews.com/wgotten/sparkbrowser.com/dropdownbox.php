...
<div class="article">
<div class="headline">
<h1 class="article-title">Dropdown Dock</h1>
<div class="clear"></div>
</div>
<div class="abr-block">
...
<br/><br/>
<br/>
<img src="images/dropdownbox.png" width="700"/>
<h3>The Sparkbrowser Dropdown Box is minimalist and saves time</h3>
<p>The Sparkbrowser dropdown box is the latest innovation in toolbars, similar to a ribbon in Microsoft Office, the Dropdown Box has all of the apps you choose to include, this allows you to switch between apps, or websites without going back to the homescreen.</p>
<p>Sparkbrowser uses the dropdown box to switch quickly between sites, often times you only use a specific set of sites for a particular task. In enteprise software like SolidWorks, toolbars can be cusomized for maximum efficientcy, this is why you can create multiple drop down boxes and switch between them on the fly.</p>
<p>Not only does the drop down box save time, but it also does not impede the visual impact of the site, the toolbar retracts back in to the menu by pressing the F10 key</p>
</div>
</div>
</div>
</div>
