...
<head>
<title>Sparkbrowser - App Store</title>
...
<div class="article">
<div class="headline">
<h1 class="article-title">Sparkbrowser App Store</h1>
<div class="clear"></div>
</div>
<div align="center"><img src="images/slides/sparkslide3.png" width="670"></img></div>
<br/>
<h2>Check out the Sparkbrowser App Store, similar to the Chrome App Store, the iphone App Store, and Firefox Extensions, our app store consists of homescreen apps, html5 applications, movies, music, and other content. Our app store is available to all Sparkbrowser users, and every app is cmpletely free. Because all of our apps are developed by Sparkbrowser, you can assure the best quality and security. Our app store is very extensive with over 1000 apps by the time of launch and many more in the coming months. To submit an app to the Sparkbrowser App Store one must complete the <a href="#">App Store Form</a> and all apps must be withing the acceptable application guldelines. </h2>
</div>
</div>
</div>
<div class="grid_3">
...
<img src="images/appstore2.png" width="225"></img>
</div><!-- END SIDEBAR B -->
</div><!-- END GRID 3 -->
<div class="clear"></div>
</div>
